...
function AudioCurImg() {
  ...
  return (
    <div
      className={clsx(
        " md:h-[240px] lg:h-[270px] h-[80%]  max-h-[90vw]  mx-auto md:mx-0 aspect-square shrink-0  fallbackAspect bg-[#343333] short:opacity-0 short:absolute  overflow-hidden relative"
      )}
    >
      <Image
        ref={imgRef}
