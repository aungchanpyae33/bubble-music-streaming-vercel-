        ...
        <div className="grid grid-cols-1  lg:grid-cols-3 sm:grid-cols-2 gap-8">
          ...
          <div className="space-y-4 sm:col-span-2 lg:col-auto col-auto">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              ...
              Nextjs တို့ဖြင့် သရုပ်ပြသရန်အတွက် ဖန်တီးထားသော ကိုယ်ပိုင်
              ဝက်ဘ်အက်ပ် ပရောဂျက်တစ်ခုဖြစ်ပါသည်။ရိူးရှင်းပြီး အသုံးပြုရ
            ...
            <div className="bg-zinc-800/50 p-3 rounded-md border border-zinc-700">
              <p className="text-amber-400 text-sm font-medium leading-relaxed">
                ...
                ကိုယ်ပိုင်နမူနာပြသမှု ပရောဂျက်တစ်ခုဖြစ်ပါသည်။ အသုံးပြုထားသော
                မည်သည့်သီချင်း/ဓာတ်ပုံဧ။် မူပိုင်ခွင့်ကိုမျှ ကျွန်တော်
                မပိုင်ဆိုင်ပါ သို့မဟုတ် မူပိုင်ခွင့်ကိုလည်း မတောင်းဆိုပါ။
                အကြောင်းအရာအားလုံးကို သရုပ်ပြသရန်အတွက်သာ အသုံးပြုပါသည်။
                ကိုယ်ပိုင်ရေးသားထားသော Source Code ကိုသာ ကျွန်တော်
                ပိုင်ဆိုင်ပါသည်။
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              ကျွန်တော်သည် လက်ရှိတွင် အခွင့်အလမ်းသစ်များ ရှာဖွေနေပါသည်။ အကယ်၍
              ကျွန်တော်နှင့် လက်တွဲလုပ်ကိုင်ရန် စိတ်ဝင်စားပါက ဆက်သွယ်နိုင်ပါသည်။
            </p>
