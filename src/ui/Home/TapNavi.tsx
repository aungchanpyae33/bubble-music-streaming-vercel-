function TapNavi() {
  return (
    <div className=" w-full p-4 h-[80px] thinScrollbar [&>*]:bg-[#222222] flex justify-between gap-3 flex-shrink-0 overflow-auto items-center max-w-[950px] flex-grow-0 text-nowrap no-scrollbar">
